...
- Notable contributions (high scale A/B tested):
    - Click-through rate: **+1.1%** Revenue Per Mille, **+16%** speed up in training data fetch time.
    - Widget viewability: **+8.2%** Reach, **+6.1%** F1-Score, **-8.5%** False Negatives (premium traffic)
    - Video viewability: **+11.2%** Reach, **+4.6%** F1-Score, **-9.5%** False Negatives
    - Conversion rate: **-1.3%** Cost Per Action, **+1.7%** Conversions, **+0.2%** Gross Revenue.
